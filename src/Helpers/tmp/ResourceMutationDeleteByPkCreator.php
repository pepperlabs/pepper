...
class ResourceMutationDeleteByPkCreator extends ResourceCreator
{
    protected $path;
    protected $stub;
    ...
    public function __construct()
    {
        ...
        $this->stub = '/mutationDeleteByPk.stub';
    }
    ...
    protected function updateConfig($name)
    {
        ...
        $key = 'delete_' . $name . '_by_pk';
        if ($this->configKeyExists('graphql.schemas.default.mutation.' . $key)) {
            $class = strval('App\GraphQL\Mutations\Pepper\\' . $className . 'DeleteByPkMutation::class');
