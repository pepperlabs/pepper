...
class ResourceMutationInsertCreator extends ResourceCreator
{
    protected $path;
    protected $stub;
    ...
    protected function updateConfig($name)
    {
        ...
        if ($this->configKeyExists('graphql.schemas.default.mutation.' . $key)) {
            $class = strval('App\GraphQL\Mutations\Pepper\\' . $className . 'InsertMutation::class');
