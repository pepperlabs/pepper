...
class ResourceMutationUpdateByPkCreator extends ResourceCreator
{
    protected $path;
    protected $stub;
    ...
    public function __construct()
    {
        ...
        $this->stub = '/mutationUpdateByPk.stub';
    }
    ...
    protected function updateConfig($name)
    {
        ...
        $key = 'update_' . $name . '_by_pk';
        if ($this->configKeyExists('graphql.schemas.default.mutation.' . $key)) {
            $class = strval('App\GraphQL\Mutations\Pepper\\' . $className . 'UpdateByPkMutation::class');
